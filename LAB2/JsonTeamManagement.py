...
t1 = FootballTeam("Динамо Київ", [2, 1, 3, 0], "Україна", "УПЛ", 15, "Олександр Шовковський")
t2 = BasketballTeam("Лейкерс", [102, 98, 110], "США", "NBA", 25, "Дарвін Хем")
t3 = FootballTeam("Барселона", [3, 4, 2, 1], "Іспанія", "Ла Ліга", 20, "Хансі Флік")
t4 = FootballTeam("Ліверпуль", [2, 4, 3, 1], "Англія", "АПЛ", 17, "Арне Слот")
